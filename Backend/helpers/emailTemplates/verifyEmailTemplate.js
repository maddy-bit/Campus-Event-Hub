const verifyEmailTemplate = (emailOtp) => `
    ...
    <tr>
      <td align="center" style="padding:40px 20px;">
        <table width="100%" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:24px; background:#b9ff66; border-bottom:4px solid #000;">
          ...
          <tr>
            <td style="padding:32px;">
              <h2 style="margin:0 0 16px; font-weight:800;">VERIFY YOUR EMAIL</h2>
              <p>Use the OTP below to complete your registration.</p>

              <div style="margin:24px 0; padding:24px; border:4px solid #000; background:#ffe66d; text-align:center;">
